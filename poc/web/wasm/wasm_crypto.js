 ...
 * @returns {string}
 */
export function datamap_from_bincode(bincode_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {string}
 */
export function datamap_from_msgpack(msgpack_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
 ...
 * @returns {Uint8Array}
 */
export function decrypt_chunk_wasm(chunk_index, encrypted_content, src_hashes_json, child_level) {
 ...
 * @returns {string}
 */
export function extract_src_hashes(msgpack_bytes) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passArray8ToWasm0(msgpack_bytes, wasm.__wbindgen_malloc);
